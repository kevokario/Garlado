                    ...
                    for (var i = 0; i < jsonData.length; i++) {
                        ...
                        js += `<tr>
                                ...
                                <td class="shoping__cart__quantity">
                                    ` + parseInt(jsonData[i][1]) / parseInt(jsonData[i][2]) + `
                                </td>
                                <td class="shoping__cart__quantity">` + jsonData[i][2] + `</td> 
                                
                                <td class="shoping__cart__price">
                                ` + jsonData[i][1] + `
                                </td>
                                <td class="shoping__cart__item__close">
                                    <button class="btn btn-sm btn-info" onclick="removeFromCart1(this.value,this)" value="` + i + `"><i class="fa fa-trash-o"></i>
                                    </button>
                                </td>
                            </tr>`;
                    }
...
function removeFromCart1(str, btn) {
    ...
    $(btn).children('i').addClass('fa fa-spinner fa-spin');
    $.post('Core/preloader.php',
            {
...
function buyItems(btn) {
    var txt = `<h4 style="font-weight:bold;margin-bottom : 7px">
                    You are not logged in yet!
                </h4>
                <p class="text-justify">
                    Click here to <a href="checkout.php">login</a>
                <p>`;
    var txt1 = 'Done!';
    ...
    $.post(
            ...
            function (data, success) {
                ...
                if (data === 'no') {
                    ...
                    document.location.href='my-order.php';
                }
            }
    );
